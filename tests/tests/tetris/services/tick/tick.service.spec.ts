...
import { EMPTY_PERIOD, ITickService, TickService, periodToSpeed, speedToPeriod } from "../../../../../src/games/tetris/services/tick";
...
describe('TickService', () => {
    ...
    it('should add speed correctly', () => {
        ...
        service.addSpeed(2);
        const periodValue = service['period']();
        const expectedPeriod = speedToPeriod(periodToSpeed(service['period']()) + 0);
